...
async function authorCreate(first_name, family_name, d_birth, d_death, image_path) {
  const authordetail = { first_name: first_name, family_name: family_name, image_path: image_path };
...
async function createAuthors() {
  ...
  await Promise.all([
    authorCreate("Patrick", "Rothfuss", "1973-06-06", false, "/images/author1.png"),
    authorCreate("Ben", "Bova", "1932-11-8", false, "/images/author1.png"),
    authorCreate("Isaac", "Asimov", "1920-01-02", "1992-04-06", "/images/author2.png"),
    authorCreate("Bob", "Billings", false, false, "/images/author3.png"),
    authorCreate("Jim", "Jones", "1971-12-16", false, "/images/author4.png"),
  ]);
}
